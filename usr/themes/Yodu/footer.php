...
<footer id="footer" class="footer">
 <?php if ($this->options->starttime){ ?><span>博客已萌萌哒运行</span><span id=span_dt_dt></span><?php };?>
...
<script src="'.theurl.'js/jquery.fancybox.min.js?ver=3.2.5" data-instant-track></script><script src="'.theurl.'load.js?v='.Yodu_Version.'"></script>';
